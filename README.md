...
_Origami Tobiichi. Одной из черт ее характера является настойчивость. Если у нее есть какая-то цель, то она готова сделать всё, что в ее силах, чтобы достичь ее._
...
- `origami.b` - уведомление __консюмера__ о новом запросе
  ...
  СООБЩЕНИЕ:
  6ba04b7c-705f-4f86-9d77-a822d11acdb1{"param":"value"}
